...
hi  Comment                                 cterm=NONE      ctermfg=10              gui=NONE     guifg=#586e75
hi  Folded                                  cterm=NONE      ctermfg=10 ctermbg=NONE gui=NONE     guifg=#839496  guibg=#073642  guisp=#002b36
hi  FoldColumn                              cterm=NONE      ctermfg=14 ctermbg=8 gui=NONE     guifg=#839496  guibg=#073642
hi  Conceal                                                 ctermfg=4               gui=NONE     guifg=#268bd2
hi  Cursor                                                  ctermfg=8  ctermbg=12   gui=NONE     guifg=#002b36  guibg=#839496
hi  Todo                                    cterm=bold      ctermfg=0  ctermbg=3    gui=bold     guifg=#d33682  guibg=NONE

hi  Search                                  cterm=reverse   ctermfg=3  ctermbg=NONE gui=reverse  guifg=#b58900  guibg=NONE
hi  IncSearch                               cterm=standout  ctermfg=9               gui=standout guifg=#cb4b16  gui=standout

" VIM WINDOW
hi  LineNr                                                  ctermfg=10 ctermbg=0    gui=NONE     guifg=#586e75  guibg=#073642
hi  ColorColumn                                                        ctermbg=0    gui=NONE                    guibg=#073642
hi  CursorColumn                            cterm=NONE                 ctermbg=0    gui=NONE                    guibg=#073642
hi  CursorLine                              cterm=NONE                 ctermbg=0    gui=NONE                    guibg=#073642  guisp=#93a1a1
hi  CursorLineNr                            cterm=NONE      ctermfg=7               gui=NONE     guifg=yellow

hi  StatusLine                              cterm=NONE      ctermfg=8  ctermbg=10                guifg=#93a1a1  guibg=#073642  gui=reverse
hi  StatusLineNC                            cterm=NONE      ctermfg=8  ctermbg=10                guifg=#657b83  guibg=#073642  gui=reverse


" ORGANIZE LATER
hi  ConId                                                           ctermfg=3                     gui=NONE      guifg=#b58900  
hi  Constant                                                        ctermfg=6                     gui=NONE      guifg=#2aa198  
